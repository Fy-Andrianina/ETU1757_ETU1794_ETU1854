  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" ><img style="width:60%; height:10%" src="<?php echo base_url() ?>assets/image/admin/logo.PNG" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" ><img style="width:100%; height:100%" src="<?php echo base_url() ?>assets/image/admin/logo.PNG" alt="logo"/></a>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>admin/Painting_ctrl/painting_ajout_page"> Ajouter sport </a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-B">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>admin/Compte_ctrl/grand_livre_page"> En cours </a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic36">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>admin/Compte_ctrl/grand_livre_page"> Validation </a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url() ?>admin/Compte_ctrl/balance_page"> Les codes </a></li>
              </ul>
            </div>
          </li>
        </ul>
