                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>admin/Regime_ctrl/adding_regime" method = "POST" class="forms-sample" enctype="multipart/form-data">
                            ...
                            <!-- COMPOSITION DU REGIME -->
                            <h3 class="text-muted" style="margin-left:5%;margin-bottom: 3%"> Composition du regime </h3>
                              <!-- Composition en VIANDE -->
                              <div class="form-group row">
                                <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Taux en viande : </label><br>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="comp_viande" id="exampleInputConfirmPassword2">
                                </div>
                            </div>              
                                
                        <!-- Composition en Poisson -->
                             <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Taux de poisson : </label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="comp_poisson" id="exampleInputConfirmPassword2">
                                </div>
                            </div>      
                                
                            <!-- Composition en Volaille -->
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Taux de volaille : </label>
                                <div class="col-sm-9">
                                <input type="number" class="form-control" name="comp_volaille" id="exampleInputConfirmPassword2">
                                </div>
                            </div>        
