 ...
 <div class="main-panel">        
    <div class="content-wrapper">
        <h3 class="text-muted" style="margin-left:5%;margin-bottom: 3%"> Nouveau sport </h3>
        <div class="row align-items-center">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>admin/Sport_ctrl/adding_sport" method = "POST" class="forms-sample" enctype="multipart/form-data">
                            <!-- Nom -->
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nom : </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name_sport">
                                </div>
                            </div>
                            ...
                            <!-- DUREE -->
                            <div class="form-group row">
                                <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Duration (semaine) : </label>
                                <div class="col-sm-9">
                                <input type="number" class="form-control" name="durree_intervalle" id="exampleInputConfirmPassword2">
                                </div>
                            </div>
