...
<main class="login-body" >
    <!-- Login Admin -->
    <form class="form-default" action="<?php echo base_url() ?>Login_con/check_login_user/" method="POST">
        
        <div class="login-form">
            <!-- logo-login -->
            <div class="logo-login">
                <a href="index.html"><img src="<?php echo site_url('assets/Image/logo.png') ?>" alt=""></a>
            </div>
            <h2>Se connecter</h2>
            ...
            <a href="<?php echo base_url() ?>Sign_con/" class="registration" style="font-size:30px"> S'inscrire</a>
        </div>
    </form>
    <!-- /end login form -->
</main>
