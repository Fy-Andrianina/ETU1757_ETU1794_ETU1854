...
<main class="login-body" >
    <!-- Login Admin -->
    <form class="form-default" action="<?php echo base_url() ?>Utilisateur_con/inscription" method="POST">
        ...
        <div class="login-form">
            ...
            <!-- Forget Password -->
            <a href="<?php echo base_url() ?>" class="registration" style="font-size:30px">Retour</a>
        </div>
    </form>
    <!-- /end login form -->
</main>
